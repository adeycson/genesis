    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cor_tema', models.CharField(default='#FFFFFF', help_text='Insira um código de cor hexadecimal.', max_length=7, verbose_name='Cor do Tema')),
                ('logo', models.ImageField(blank=True, null=True, upload_to='logos/', verbose_name='Logotipo da Empresa')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usuarios', to='apps.empresa', verbose_name='Empresa associada')),
