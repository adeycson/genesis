...
msgstr "Excedida a quantidade de tentativas de login. Tente novamente mais tarde."
...
#: account/forms.py:92 account/forms.py:412 account/forms.py:552
#: account/forms.py:689
msgid "Password"
msgstr "Senha"
...
#: account/forms.py:418 account/forms.py:555
...
#: account/forms.py:532 account/forms.py:638
msgid "New Password"
msgstr "Nova Senha"

#: account/forms.py:535 account/forms.py:639
...
"email address."
msgstr "Você não pode ativar a autenticação de dois fatores até verificar seu endereço de e-mail"
...
#: mfa/apps.py:7
msgid "MFA"
msgstr "Autenticação de Múltiplos Fatores"

#: mfa/forms.py:16 mfa/forms.py:18 mfa/forms.py:55
msgid "Code"
msgstr "Código"
...
#: socialaccount/adapter.py:137
msgid "Your account has no password set up."
msgstr "Sua conta não tem uma senha definida."

#: socialaccount/adapter.py:144
...
msgstr "ID do App ou chave do consumidor"
...
msgstr "Segredo de API, segredo de cliente ou segredo do consumidor"
...
msgstr "Resposta inválida ao obter token de permissão de \"%s\". A resposta foi: %s."
...
msgstr "Autentique novamente para proteger sua conta"
...
#: templates/account/email.html:45 templates/account/email_change.html:44
...
msgstr ""
"Você está recebendo este e-mail porque você ou outra pessoa tentou se inscrever em:"
"an\n"
"conta usando endereço de e-mail:"
"\n"
"%(email)s\n"
"\n"
"No entanto, já existe uma conta usando esse endereço de e-mail. Caso você tenha esquecido"
"have\n"
"use por favor o procedimento de recuperação de senha:"
"recover\n"
"your account:\n"
"\n"
"%(password_reset_url)s"
...
msgstr "Essa conta já existe"

#: templates/account/email/base_message.txt:1
#, python-format
msgid "Hello from %(site_name)s!"
msgstr "Olá %(site_name)s!"
...
"%(site_domain)s"
msgstr ""
"Obrigado por usar o %(site_name)s!\n"
"%(site_domain)s"
...
msgstr ""
"Você está recebendo essa mensagem porque você ou alguém tentou recuperar ou redefinir "
"uma senha para sua conta de usuário no site %(site_domain)s.\n"
"Caso tenha sido você que fez a requisição, simplesmente ignore a "
"mensagem e clique no link abaixo para redefinir a senha. "
...
"a\n"
" uma senha para sua conta de usuário. No entanto, não temos nenhum registro de "
"user\n"
" e-mail %(email)s cadastrado em nosso banco de dados.\n"
"\n"
"Caso não tenha sido você que fez a requisição, simplesmente ignore a "
"mensagem.\n"
" Você pode se inscrever para uma conta usando o link abaixo."
...
#: templates/account/email_change.html:20
#| msgid "Current Password"
msgid "Current email"
msgstr "E-mail Atual"
...
#: templates/account/email_change.html:30
#| msgid "Your primary email address must be verified."
msgid "Your email address is still pending verification."
msgstr "Seu endereço de e-mail ainda está pendente de verificação."

#: templates/account/email_change.html:36
#| msgid "Email"
msgid "Change to"
msgstr "Mudar para"

#: templates/account/email_change.html:47
msgid "Cancel Change"
msgstr "Cancelar alteração"

#: templates/account/email_change.html:51
...
msgstr ""
"Por favor confirme se <a href=\"mailto:%(email)s\">%(email)s</a> é um "
...
"account."
msgstr "Não foi possível confirmar %(email)s porque já foi confirmado por uma outra conta."
...
"mensagem com instruções sobre como recuperar."
...
"que você é quem diz que é. Para esse fim, pedimos que confirme que\n"
...
"Por favor insira um código de autenticação:"
...
msgstr[0] "Existe %(unused_count)s out of %(total_count)s código de recuperação disponível."
msgstr[1] "Existem %(unused_count)s out of %(total_count)s códigos de recuperação disponíveis."
...
msgstr ""
"Para proteger sua conta com autenticação de dois fatores, escaneie o QR code "
"abaixo com seu aplicativo autenticador. Em seguida, insira o código de verificação "
"gerado pelo aplicativo abaixo."
...
"a later time."
msgstr ""
"Você pode armazenar esse segredo e usá-lo para reinstalar seu aplicativo autenticador "
"mais tarde."
...
"sure?"
msgstr ""
"Você está prestes a desativar a autenticação baseada em aplicativo autenticador. "
"Tem certeza?"
...
msgstr ""
"Você está prestes a fazer login usando uma conta externa do provedor "
"%(provider)s."
...
msgstr "Ou use um externo (terceiro)"
...
#: usersessions/apps.py:7
msgid "User Sessions"
msgstr "Sessões de usuário"

#: usersessions/models.py:46
msgid "session key"
msgstr "chave de sessão"

#~| msgid "The following email addresses are associated with your account:"
#~ msgid "The following email address is associated with your account:"
#~ msgstr "O seguinte endereço de e-mail está associado à sua conta:"

#~| msgid "Confirm Email Address"
#~ msgid "Change Email Address"
#~ msgstr "Mude o endereço de e-mail"
